          ...
          <div className="flex justify-around items-center py-4">
            ...
            >
              ...
              <div className="relative flex flex-col items-center gap-1">
                <svg className="w-7 h-7 text-slate-300 group-hover:text-white transform group-hover:scale-110 transition-all duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            >
              ...
              <div className="relative flex flex-col items-center gap-1">
                <svg className="w-7 h-7 text-white transform group-hover:scale-110 transition-all duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
