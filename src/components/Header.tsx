...
export default function Header({
  ...
  return (
    <header className="sticky top-0 z-50 bg-gradient-to-br from-[#DC143C] via-[#C41E3A] to-[#0039A6] text-white shadow-xl w-full transition-all duration-300">
      <div className="w-full px-4 sm:px-6 lg:px-12 xl:px-16 py-3 lg:py-4">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 lg:gap-8">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center gap-6 lg:gap-12 order-2 lg:order-1 flex-1">
            ...
            <div className="text-center lg:text-left">
              <div className="flex items-center justify-center lg:justify-start gap-3">
                ...
                <div>
                  <h1 className="text-xl md:text-2xl lg:text-3xl font-bold tracking-tight leading-tight" style={{ fontFamily: "'Playfair Display', serif" }}>
                    {t('title')}
                  </h1>
                  <p className="text-white/80 text-[11px] md:text-xs font-light tracking-wide mt-0.5 hidden lg:block">
                    {t('subtitle')}
                  </p>
                </div>
              </div>
              <p className="text-white/80 text-[11px] font-light tracking-wide mt-1 lg:hidden">
                {t('subtitle')}
              </p>
            </div>
          ...
          <div className="flex justify-end lg:justify-end items-center gap-4 order-1 lg:order-2">
            ...
            <a
              ...
              className="hidden lg:flex items-center gap-2 bg-[#0088cc] hover:bg-[#0077b5] text-white px-4 py-2 rounded-lg transition-all duration-200 shadow-md hover:shadow-lg"
              title="Telegram"
            >
              ...
              <span className="font-semibold hidden xl:inline">Telegram</span>
            </a>
            <a
